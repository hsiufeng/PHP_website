...
<form action="/pholic/mod_manage.php" enctype="multipart/form-data" method="post">
...
if($result=mysqli_query($link,$sql)){ 
  while($row=mysqli_fetch_assoc($result)){
    ...
    echo "<h4>大頭貼: <input type='file' name='file'></h4>";
    
  }
  //echo "<h4><input type ='button' value='儲存變更' onclick='this.form.action='/pholic/mod_manage.php';this.form.submit();'></h4>";
  echo "<h4><button onclick='/pholic/mod_manage.php'>儲存變更</button></h4>";    
}
/*function mod_pro(){
