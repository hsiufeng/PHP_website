...
<h2><i>MORE</i></h2></br>
<h3><form method="post" enctype="multipart/form-data" action="/pholic/post_upload_manage.php"></h3>
...
if($result=mysqli_query($link,$sql)){
  while($row=mysqli_fetch_assoc($result)){
    echo "<form method='post' enctype='multipart/form-data' action='/pholic/reply_upload_manage.php'>";
