...
<h2><i>MORE</i></h2></br>
<h3><form method="post" enctype="multipart/form-data" action="post_upload_manage.php"></h3>
<h3><a href = "/pholic/main_manage.php"><img src="/pholic/img/007.png"></a></br></h3>
<?php
...
<h3><a href = "/pholic/profile_manage.php"><img src="/pholic/img/008.png"></a></br><a href = "/pholic/post_manage.php"><img src="/pholic/img/010.png"></a></br><a href = "/pholic/manage.php"><img src="/Pholic/img/011.png"></a></br><a href = "/pholic/logout.php"><img src="/pholic/img/009.png"></a></br></h3>
</form></div>
...
if(@$class_no==1){
	...
	$sql="SELECT distinct* FROM post,user,class WHERE post.mail=user.mail and class.class_no=".$class_no." and post.class_no=class.class_no ORDER BY post_no DESC";
}
if($result=mysqli_query($link,$sql)){
  while($row=mysqli_fetch_assoc($result)){
