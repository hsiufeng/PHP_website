...
<h2><i>MORE</i></h2></br>
<h3><a href = "/pholic/main.php"><img src="/pholic/img/007.png"></a></br><a href = "/pholic/profile.php"><img src="/pholic/img/008.png"></a></br><a href = "/pholic/logout.php"><img src="/pholic/img/009.png"></a></br></h3></div>
...
if($result=mysqli_query($link,$sql)){ 
  ...
  echo "<h4><button onclick='/pholic/mod_pro.php'>儲存變更</button></h4>";    
}
/*function mod_pro(){
