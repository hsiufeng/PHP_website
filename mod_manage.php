...
echo $user_name;
  ...
  $sql_update="UPDATE user SET pwd= '$pwd' , user_name= '$user_name', user_bday= '$user_bday' where mail='$mail'";
...
if($_FILES["file"]["name"]!= null){
  ...
  header("Location: /pholic/profile_manage.php"); 
  }else{
  	echo "檔案格式錯誤!請重新選擇";
   header("refresh: 3 ;Location: /pholic/changing_1.php");
