...
$sql="SELECT * FROM user,post WHERE post.mail=\"".$user_mail."\" and user.mail=post.mail ORDER BY post_no DESC;";
//echo $sql;
...
if($result=mysqli_query($link,$sql)){
	...
	echo "<br/><a href='post_user_del.php?post_no=".@$row["post_no"]."'>刪除文章<br/></a>";
	echo "</br>---------------------------------------------------</br>";
  }    
}else{
	echo "ERROR";
