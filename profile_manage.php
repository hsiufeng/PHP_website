...
<form method="post" action="/pholic/changing_1.php" enctype="multipart/form-data"> 
<div id= "container">
...
if($result=mysqli_query($link,$sql)){ 
  while($row=mysqli_fetch_assoc($result)){
    ...
    echo "<h4>大頭貼: <img src = \"/pholic/img/".$row["user_pic"]."\" width = '150' height = '150'></h4>";
    //echo "<h4><input type='button' value='更換大頭貼' onclick='post_upload.php'/></h4>";
  }    
}
}else{echo "NO";}
echo "<h4><input type='submit' value='編輯' onclick='self.location.href='changing_manage.php''/></h4>";
